...
**First assumption:** You have run G33 and have an acceptable standard deviation number of <0.6.  
...
1. This [link](https://goo.gl/7nX3MF) will take you to an online spread sheet which has three pages at the moment. Go there and open the "Dimensions" page (look down for pages).  
...
Print the object again. Your dimensions should be closer to expected. If they aren't perfect, just redo this procedure.
