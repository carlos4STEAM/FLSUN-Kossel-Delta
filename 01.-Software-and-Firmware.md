...
*Explanation for step 8: After a while, the different updates of Marlin-AC will start to get overwhelming and in order to have control over your current working configuration, it is advised to renaming the folders according to the version numbers.  
