...
** IMPORTANT ** After flashing the firmware (now and in the future), do not forget to send the commands `M502` and M500` to overwrite the old EEPROM values with the fresh ones.  
