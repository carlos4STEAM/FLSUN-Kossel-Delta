...
`Zx.xx` : Sets the Z-shift = print height of the 1st layer - probe trigger height; every subsequent G33 will use the last Z-shift set. (Use G33 P0 Zx.xx for quick set) (Marlin 1.1.7 upwards).  
