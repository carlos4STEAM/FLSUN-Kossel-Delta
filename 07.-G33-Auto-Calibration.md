...
`Zx.xx` : Sets the Z-shift, formerly known as Z-offset. Every subsequent G33 will use the last Z-shift set. (Marlin 1.1.7 upwards)  

**Examples**  
`G33` : calibrates with the default settings.  
`G33 Z0.03` : sets the z-shift to 0.03 mm.  
