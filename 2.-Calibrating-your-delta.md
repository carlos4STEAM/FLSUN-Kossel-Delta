...
1) Mark a fixed point on the frame of all 3 axes. You can use some paper tape for instance. Or you can use Steve Hennerley's method: Put your calipers under the carriage and extend it >100mm. Zero it and keep to in one place while the carriage pushes the caliper stick down.
